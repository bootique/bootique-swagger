...
@BQTest
@DisplayName("'redoc' config options")
public class ConfigOptionsIT {
    ...
    public void testConfig() {
        ...
        Response r = target.path("/redoc").request().get();
    ...
    public void testNoSpecUrlNoSpecPath() {
        ...
        Response r = target.path("/redoc-nospecs").request().get();
    ...
    public void testApi_Console() {
        ...
        Response r = target.path("/redoc-x").request().get();
        JettyTester.assertOk(r)
