 ...
 * @since 2.0
 */
@BQConfig("A Redoc 'console' pointing to a specific API model")
public class RedocModelFactory {
    ...
    public RedocServletModel createModel() {
        return new RedocServletModel(specUrlResolver(), uiPath());
    }
    ...
    private String uiPath() {
        return uiPath != null ? uiPath : "/redoc";
    }
