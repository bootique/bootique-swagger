 ...
 * under the License.
 */
package io.bootique.swagger.redoc.model;
 ...
 * @since 2.0
 */
public class RedocServletModel {

    private final Function<HttpServletRequest, String> specUrlResolver;
    private final String uiPath;

    public RedocServletModel(Function<HttpServletRequest, String> specUrlResolver, String uiPath) {
        this.specUrlResolver = specUrlResolver;
        this.uiPath = uiPath;
    }

    public RedocServletTemplateModel createTemplateModel(HttpServletRequest request) {
        String apiUrl = getSpecUrl(request);
        String resourcePath = getResourcePath(request);
        return new RedocServletTemplateModel(apiUrl, resourcePath);
    }
